...
handler.tags = ['لعبة'];
handler.command = /^(حب|صداقة|صديق-عشوائي|مزاح|مغازلة|تشكيل-زوج|تشكيل-أزواج|شخصية|محاكاة-اختراق|اختراق-مزيف|اختراق|اخترقني|متميز|نسبة-تميز|أناقة|كسل|كسول|نشاط|نشيط|مهارة|ذكاء|جاذبية|هدية|إهداء|إرسال|تحدي|رتط|سؤال|أسئلة|هل|توب|توب-متميزين|توب-أنمي|توب-أصدقاء|توب-مرحين|توب-أنيقين|توب-مبدعين|توب-كسالى|توب-جميلين|توب-مشاهير|توب-أزواج|توب-5أزواج|روليت|حظ)$/i;
